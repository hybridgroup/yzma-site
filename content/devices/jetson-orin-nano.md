...
yzma uses the GPU with CUDA or Vulkan. With a small text model and CUDA, the board makes approximately 190 tokens a second.
...
- [Getting started on the Jetson Orin](/getting-started/install/jetson-orin/)
